...
export MENDER_UPDATE_POLL_INTERVAL_SECONDS=${MENDER_UPDATE_POLL_INTERVAL_SECONDS:= 1800}

export MENDER_INVENTORY_POLL_INTERVAL_SECONDS=${MENDER_INVENTORY_POLL_INTERVAL_SECONDS:= 1800}

export MENDER_RETRY_POLL_INTERVAL_SECONDS=${MENDER_RETRY_POLL_INTERVAL_SECONDS:= 300}
